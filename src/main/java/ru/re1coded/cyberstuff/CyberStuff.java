...
public class CyberStuff {
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "cyberstuff" namespace
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "cyberstuff" namespace
    ...
    // Creates a new Block with the id "cyberstuff:example_block", combining the namespace and path
    public static final DeferredBlock<Block> EXAMPLE_BLOCK = BLOCKS.registerSimpleBlock("example_block", p -> p.mapColor(MapColor.STONE));
    // Creates a new BlockItem with the id "cyberstuff:example_block", combining the namespace and path
    public static final DeferredItem<BlockItem> EXAMPLE_BLOCK_ITEM = ITEMS.registerSimpleBlockItem("example_block", EXAMPLE_BLOCK);

    // Creates a new food item with the id "cyberstuff:example_id", nutrition 1 and saturation 2
    ...
    public CyberStuff(IEventBus modEventBus, ModContainer modContainer) {
        ...
        CustomDataComponent.register(modEventBus);
